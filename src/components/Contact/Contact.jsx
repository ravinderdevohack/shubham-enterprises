  ...
  return (
    <div className='mt-6 min-h-160 flex  items-center justify-center'>
      <div className='flex items-center justify-center flex-col '>
        <div className='flex items-center justify-center bg-gray-100 w-80 rounded-2xl lg:w-full lg:rounded-lg'>
          <p className='rounded-xl px-2 py-4 font-semibold tracking-tight text-center opacity-70 '>
            Get Your Crane Back to Work,  Don’t let a broken part or maintenance issue stall your project. <br />
            Contact the experts at <span className='text-orange-800 font-extrabold'>Shubham Enterprises </span> for a free quote or technical consultation
          </p>
